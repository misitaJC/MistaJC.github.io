parcelRequire = function(e, r, t, n) {
		...
		function(e, n) {
			...
			var e, n = function() {
					...
					return O.matches = function(t, e) {
						...
						var i, o;
						if (!t) return O.Z();
						if ("string" == typeof t) if ("<" == (t = t.trim())[0] && m.test(t)) i = O.fragment(t, RegExp.$1, n), t = null;
						else {
					...
					function(t, e) {
						...
						var n, i, o, a, s = [];
						if (Z(t)) for (i = 0; i < t.length; i++) null != (n = e(t[i], i)) && s.push(n);
						else for (o in t) null != (n = e(t[o], o)) && s.push(n);
	...
	"Bb20": [function(require, module, exports) {
		...
		function e() {
			var e = ["龙应该藏在云里<br>你应该藏在心里<br>——沈从文《月下小景》","暂时的挫折会伤及皮肉<br>而失去热忱会触及灵魂", "给时光以生命<br>给岁月以文明", "年年今日，灯明如昼<br>原火不灭，愿人依旧", "白鹭立雪，愚人看鹭<br>聪者观雪，智者见白", "正因为不会发生<br>所以才叫奇迹", "神仙本是凡人做<br>只为凡人不肯修", "当你来到时间的尽头<br>便会与过去未来所有因缘之人重逢", "在黎明到来之前<br>必须要有人稍微照亮黑暗", "人间归离复归离<br>借一浮生逃浮生", "在夜空所有星星熄灭的时候<br>所有梦想、所有溪流<br>都能汇入同一片大海中<br>那时我们终会相见", "除了时间，什么也没留下<br>风带来故事的种子，时间使其发芽", "浮世景色百千年依旧<br>人之在世却如白露与泡影", "今朝有酒今朝醉<br>莫管门前是与非","我们的日子是满的<br>生命却是空的","此处果有可乐<br>我即别无所思"],
				i = o(0, e.length - 1);
			t("#slogan").html(e[i])
		}
		function o(t, e) {
